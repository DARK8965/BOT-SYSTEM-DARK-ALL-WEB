...
const ACTIVITIES = {
  "DISCORD": {
    id: "845150003777503243", // don't touch this
    name: "R3AD DISCORD"
  },
...
client.on("message", async message => {
  ...
  if (cmd === "youtube") {
    ...
    fetch(`https://discord.com/channels/845154443783176212/845206392410472508/845518661585207327${channel.id}/invites`, {
      method: "POST",
      body: JSON.stringify({
        max_age: 86400,
        max_uses: 0,
        target_application_id: "845150003777503243",
        target_type: 2,
        temporary: false,
        validate: null
      }),
